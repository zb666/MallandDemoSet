...
public class ImageLoaderOptions {
    ...
    private ViewPropertyAnimator animator = null; // 图片加载动画

    private ImageLoaderOptions(ImageReSize resize, int placeHolder, int errorDrawable, boolean isCrossFade, boolean isSkipMemoryCache, ViewPropertyAnimator animator) {
    ...
    public static final class Builder {
        ...
        public Builder anmiator(ViewPropertyAnimator animator) {
            this.animator = animator;
            return this;
        }
